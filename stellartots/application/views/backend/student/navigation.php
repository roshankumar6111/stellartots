        ...
        ?> ">
            ...
            <ul>
                <li class="<?php if ($page_name == 'weekly_progress_report') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?student/weekly_progress_report_display">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('Weekly_progress_report'); ?></span>
                    </a>
                </li>
  ...
  <!-- end of weekly progress report -->
        ...
        <!-- Weekly Meal plan -->
         <li class="<?php if ($page_name == 'meal') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?<?php echo $account_type;?>/meal">
