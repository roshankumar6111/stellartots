...
<!-- Weekly Meal plan -->
         <li class="<?php if ($page_name == 'meal') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/meal">
                <i class="entypo-droplet"></i>
                <span><?php echo get_phrase('Weekly Meal plan'); ?></span>
            </a>
        </li>
        
<!--End of Weekly Meal plan-->
         <!-- weekly progress report -->
        <li class="<?php
        if ($page_name == 'Weekly_progress_report' ||
//                $page_name == 'grade' ||
                $page_name == 'weekly_progress_report' ||
                   $page_name == 'weekly_exam_marks_sms' )
                            echo 'opened active';
        ?> ">
            <a href="#">
                <i class="entypo-graduation-cap"></i>
                <span><?php echo get_phrase('weekly progress report'); ?></span>
            </a>
            <ul>
                <li class="<?php if ($page_name == 'weekly_progress_report') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/weekly_progress_report">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('Weekly_report_manage'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'weekly_progress_report_sms') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/weekly_progress_report_sms">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('send_report_by_sms'); ?></span>
                    </a>
                </li>
 ...
 <!-- end of weekly progress report -->
        <!-- weekly EXAMS -->
        <li class="<?php
        if ($page_name == 'Weekly_exam' ||
//                $page_name == 'grade' ||
                $page_name == 'weekly_exam_marks' ||
                   $page_name == 'weekly_exam_marks_sms' )
                            echo 'opened active';
        ?> ">
            <a href="#">
            ...
            <ul>
                <li class="<?php if ($page_name == 'weekly_exam') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/weekly_exam">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('Weekly_exam_list'); ?></span>
                    </a>
                </li>
                   <li class="<?php if ($page_name == 'grade') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/weekly_exam_grade">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('Weekly_exam_grades'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'weekly_exam_marks') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/weekly_exam_marks">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('Weekly_manage_marks'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'weekly_exam_marks_sms') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/weekly_exam_marks_sms">
