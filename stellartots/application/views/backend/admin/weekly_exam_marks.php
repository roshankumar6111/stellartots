	...
	<div class="col-md-12">
    	...
    	<!------CONTROL TABS END------>
            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
				<center>
                <?php echo form_open(base_url() . 'index.php?admin/weekly_exam_marks');?>
                	...
                	<tr>
                        <td>
                        	<select name="exam_id" class="form-control"  style="float:left;">
                                ...
                                <?php 
                                $exams = $this->db->get('weekly_exam')->result_array();
                ...
                <?php 
						...
						foreach($students as $row):
							...
							$query = $this->db->get_where('weekly_mark' , $verify_data);
							
							if($query->num_rows() < 1)
								$this->db->insert('weekly_mark' , $verify_data);
						 endforeach;
				?>
                <table class="table table-bordered" >
                    ...
                    <tbody>
						...
						foreach($students as $row):
							...
							?>
                            <?php echo form_open(base_url() . 'index.php?admin/weekly_exam_marks/' . $exam_id . '/' . $class_id);?>
							<tr>
								<td>
									<?php echo $row['name'];?>
								</td>
