...
class Sms_model extends CI_Model {
    ...
    function send_sms($message = '' , $reciever_phone = '')
    {
        $active_sms_service = $this->db->get_where('settings' , array(
         ...
         if($active_sms_service == 'SPEARC'){
             $tosendmessage=urlencode($message);
             $siteaddressAPI = "http://alerts.spearcommunication.net/api/web2sms.php?workingkey=A2d514c3008c6dae0110b91000c81d634&to=$reciever_phone&sender=SPEARC&message=$tosendmessage";
