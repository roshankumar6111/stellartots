...
class Parents extends CI_Controller
{
    ...
    /******** weekly progress information**********************/
     function weekly_progress_information( $class_id = '', $report_id='', $student_id='')
    {
        if ($this->session->userdata('parent_login') != 1)
            redirect(base_url(), 'refresh');
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['class_id'] > 0 ) {
                redirect(base_url() . 'index.php?parents/weekly_progress_information/' . $page_data['class_id'] , 'refresh');
            } else {
                $this->session->set_flashdata('mark_message', 'Choose class');
                redirect(base_url() . 'index.php?parents/weekly_progress_information/', 'refresh');
            }
        }
        $page_data['class_id']   = $class_id;
        $page_data['page_info'] = 'Weekly progress report';
        $page_data['page_name']  = 'weekly_progress_information';
        $page_data['page_title'] = get_phrase('manage_progress_report');
        $this->load->view('backend/index', $page_data);
    }
/******** end weekly progress report information**********************/
